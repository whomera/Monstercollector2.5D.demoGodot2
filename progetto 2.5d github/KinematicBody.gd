...
func process_player_input():
	...
	if Input.is_action_pressed("ui_right"):
		input_direction.z += 1
		raycast.set_target_position(Vector3(0, 0, 0.5))
		subraycast.set_target_position(Vector3(0, 0, 0.5))
		climbraycast.set_target_position(Vector3(0, -1, 0.5))
		...
		input_direction.x -= 1
		raycast.set_target_position(Vector3(-0.5, 0, 0))
		subraycast.set_target_position(Vector3(-0.5, 0, 0))
		climbraycast.set_target_position(Vector3(-0.5, -1, 0))
		raycast.force_raycast_update()
		subraycast.force_raycast_update()
		climbraycast.force_raycast_update()
		if climbraycast.is_colliding() and not raycast.is_colliding():
